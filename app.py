...
biographies = {
    "Benjamin Netanyau": {
        ...
        "image_urls": ["https://ilarge.lisimg.com/image/14922039/740full-benjamin-netanyahu.jpg", "https://api.time.com/wp-content/uploads/2012/05/benjamin_netanyahu_0037tpk_bw2.jpg"]
    },
    "Jens Stoltenberg": {
        ...
        "image_urls": ["https://cdn.britannica.com/65/136665-050-E7B53DEF/Jens-Stoltenberg-2009.jpg", "https://upload.wikimedia.org/wikipedia/commons/4/4c/Norges_statsminister_Jens_Stoltenberg_pa_pressmote_under_Nordiska_radets_session_i_stockholm_2009_(2).jpg"]
    },
    "Julia Gillard": {
        ...
        "image_urls": ["https://upload.wikimedia.org/wikipedia/commons/9/97/Julia-gillard-official-portrait-pmc.jpg", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcToxa2htuVdgyIYXuf3LThbXl9WPHAbjJDJNpEFTbxTj4NYgiwSSDhWzUQyTYSVZQnfDbxc"]
    },
    "Magaret Thatcher": {
        ...
        "image_urls": ["https://tse1.mm.bing.net/th?id=OIP.hZk4ElJRupT8stxLyej5vQHaHu&pid=Api&P=0&h=180", "https://tse1.mm.bing.net/th?id=OIP.pgzmNqEy6K5J211MLkabbAHaHd&pid=Api&P=0&h=180"]
    },
    "Nelson Mandela": {
        ...
        "image_urls": ["https://tse2.mm.bing.net/th?id=OIP.0PkDinpkGUxGB6NCbXb18gHaFc&pid=Api&P=0&h=180", "https://tse3.mm.bing.net/th?id=OIP.20LG85HGdtZjqU8kHchTIQHaEK&pid=Api&P=0&h=180"]
    }
}
...
def main():
    ...
    if st.session_state.page == 'upload':
        ...
        if st.button('Identify Speaker'):
            if uploaded_file is not None:
                ...
                if max_probability < 0.8:
                    st.error("Speaker not identified as it is not present in the dataset provided.")
                else:
        ...
        if 'image_urls' in st.session_state:
            # Ensure we provide a caption for each image
            captions = [st.session_state['speaker_name'] for _ in st.session_state['image_urls']]
            st.image(st.session_state['image_urls'], caption=captions, use_column_width=True, output_format='JPEG')
